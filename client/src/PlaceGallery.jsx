...
export default function PlaceGallery({place}){
        ...
        <div className="absolute inset-0 bg-black text-white min-h-screen">
           <div className=" bg-black p-8 grid gap-4">
            <div>
                ...
                <button onClick={()=>setShowAllPhotos(false)} className="fixed rounded-full bg-black shadow-lg shadow-white right-12 top-8">
    ...
    return(
        <div className="relative ">
                ...
                <button onClick={()=>setShowAllPhotos(true)} className="absolute right-2 bottom-2 py-2 px-2 bg-white border border-black rounded-2xl font-bold flex gap-1">
